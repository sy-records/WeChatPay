...
//②、统一下单
$outTradeNo = date('YmdHis').rand(100000,999999);  //你自己的商品订单号
$payAmount = 0.01;          //付款金额，单位:元
$orderName = '支付测试';    //订单标题
$notifyUrl = 'http://'. $_SERVER['HTTP_HOST'] . '/Home/api/wxnotify'; //付款成功后的回调地址(不要有问号) //自动读取域名
$payTime = time(); //付款时间
            ...
            function jsApiCall()
            {
                WeixinJSBridge.invoke(
                    ...
                    function(res){
                        ...
                        //     window.location.href='/user/index'; //支付成功后跳转页面
                        // }
                        alert(res.err_code+res.err_desc+res.err_msg);
                    }
                );
